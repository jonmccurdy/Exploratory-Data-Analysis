...
<div class="chapter-resources-header">
  <a href="https://youtu.be/fyu2Tdnygbc" target="_blank">Lecture Video (Part 1)</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/L6-Inclass-Assignment-Part-1.pdf" target="_blank">In-Class Exercises (Part 1)</a></div>
  <div><a href="https://youtu.be/CE7KowNJbW8" target="_blank">In-Class Exercises Video Solutions (Part 1)</a></div>
</div>

<div class="chapter-resources-header">
  <a href="https://youtu.be/50FCumxs9Vk" target="_blank">Lecture Video (Part 2)</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/L6-Inclass-Assignment-Part-2.pdf" target="_blank">In-Class Exercises (Part 2)</a></div>
  <div><a href="https://youtu.be/HRQmpyOhs9o" target="_blank">In-Class Exercises Video Solutions (Part 2)</a></div>
</div>

<div class="chapter-resources-footer">
  <a href="Assignments/L6-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
